...
const chartIds = ['riskRadar','rankingChart','regionChart','sankeyChart','geoDrillChart','corridorChart','atomChart'];
...
function renderAll(){
  ...
  renderRadar(c); renderRanking(); renderRegion(c); renderInputs(c); renderSankey(c); renderGeoDrill(c); renderCorridors(c); renderAtomic(c); renderTable();
}
